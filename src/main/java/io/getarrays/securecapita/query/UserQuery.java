...
public class UserQuery {
    public static final String SELECT_PAGE_NUMBER_QUERY = "QUERY SQL";
    ...
    public static final String UPDATE_USER_SETTINGS_QUERY = "UPDATE Users SET enabled = :enabled, beenon_locked = :notLocked WHERE id = :userId";
